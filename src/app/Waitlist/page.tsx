...
const WaitList = () => {
    ...
    return (
        <main className="bg-[url('/images/onlybg.svg')] h-screen text-black relative flex flex-col justify-center items-center">
            ...
            <div className="flex flex-col justify-center items-center border border-gray-200 z-20">
                ...
                <div className="text-center mt-5">
                    <span className="text-[3rem]">Join The Waitlist</span>
            ...
            <div className="absolute inset-0 z-10">
                ...
                <Image src="/images/blockchain.svg" height={30} width={30} alt="blockchain" className="absolute top-[10%] right-[30%] cursor-pointer" />
