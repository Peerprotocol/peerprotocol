...
const UserProfile = () => {
  ...
  const dataSets: Record<DataType, { label: string; data: number[]; borderColor: string; backgroundColor: string }> = {
    lend: {
      label: 'Lend',
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="p-6">
            ...
            <div className="mb-4">
              ...
              <button 
                className={`mr-2 p-2 rounded ${selectedData === 'borrow' ? 'bg-red-500 text-white' : 'bg-gray-200 text-black'}`} 
