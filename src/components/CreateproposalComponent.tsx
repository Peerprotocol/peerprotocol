...
const CreateproposalComponent = ({ show, onClose}:{show:any, onClose:any}) => {
                ...
                <div className="flex flex-col gap-4 px-8 py-4">
                    ...
                    <form method="post" className="flex flex-col gap-4">
                        ...
                        <input
                            ...
                            className="h-[10vh] flex w-[50%] rounded-2xl px-4 text-[1.2rem] bg-[#ffffff2c] border-none outline-none"
                        />
                        <button type="submit" className="mt-4 rounded-full px-4 py-4 text-[1.2rem] bg-green-600 w-[50%] self-center">
                            Submit
                        </button>
                    </form>
                </div>
